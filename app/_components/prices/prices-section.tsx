...
const PricesSection = () => {
  return (
    <div className="p-4 lg:px-10 xl:px-20 flex flex-col gap-y-4">
      ...
      <div className=" mt-9 lg:mt-12 flex flex-wrap  gap-5 lg:gap-8 xl:gap-10 justify-center md:justify-start xl:justify-around ">
        <PricePlanCard
          name="Essential"
          price="$1050"
          features={[
